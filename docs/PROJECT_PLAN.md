...
- [ ] ویرایش / حذف / اشتراک‌گذاری
- [ ] دکمه‌ی دایره‌ای روشن/خاموش
- [ ] انتخابگر حالت (SystemProxy / TUN)
- [ ] تیک «اتصال خودکار»
- [ ] کامیت و پوش

### ⬜ فاز ۶ — تست سرور + اتصال خودکار + پروکسی سیستم
- [ ] ServerTester (HTTPing از طریق socks موقت)
- [ ] منطق AutoConnect
- [ ] اعمال پروکسی سیستم (رجیستری ویندوز)
- [ ] کامیت و پوش

### ⬜ فاز ۷ — حالت TUN (VPN)
- [ ] یکپارچه‌سازی `wintun.dll`
- [ ] کانفیگ inbound tun + نیازمند admin
- [ ] کامیت و پوش

### ⬜ فاز ۸ — تنظیمات + i18n + RTL
- [ ] پنجره/قسمت تنظیمات کامل
- [ ] i18n با `.resx` (fa/en)
- [ ] RTL برای فارسی
- [ ] کامیت و پوش
...
### ⬜ فاز ۹ — پردازش نهایی
- [ ] آیکون system tray
- [ ] اجرای خودکار هنگام استارت ویندوز
- [ ] بسته‌بندی / installer
- [ ] کامیت و پوش
